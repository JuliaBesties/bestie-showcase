...
DocMeta.setdocmeta!(StrategyLevel2Moderate, :DocTestSetup, :(using StrategyLevel2Moderate); recursive = true)
...
makedocs(;
    modules = [StrategyLevel2Moderate],
    authors = "Bestie Template <me@bestie.tmp>",
    repo = "https://github.com/JuliaBesties/StrategyLevel2Moderate.jl/blob/{commit}{path}#{line}",
    sitename = "StrategyLevel2Moderate.jl",
    format = Documenter.HTML(; canonical = "https://JuliaBesties.github.io/StrategyLevel2Moderate.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/JuliaBesties/StrategyLevel2Moderate.jl")
