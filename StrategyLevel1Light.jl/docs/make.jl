...
DocMeta.setdocmeta!(StrategyLevel1Light, :DocTestSetup, :(using StrategyLevel1Light); recursive = true)
...
makedocs(;
    modules = [StrategyLevel1Light],
    authors = "Bestie Template <me@bestie.tmp>",
    repo = "https://github.com/JuliaBesties/StrategyLevel1Light.jl/blob/{commit}{path}#{line}",
    sitename = "StrategyLevel1Light.jl",
    format = Documenter.HTML(; canonical = "https://JuliaBesties.github.io/StrategyLevel1Light.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/JuliaBesties/StrategyLevel1Light.jl")
