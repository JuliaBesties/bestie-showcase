...
- [StrategyLevel0Tiny.jl](StrategyLevel0Tiny.jl): Smallest package, i.e., "no" to every addition.
- [StrategyLevel1Light.jl](StrategyLevel1Light.jl): Starting point for most packages.
...
- [StrategyLevel2Moderate.jl](StrategyLevel2Moderate.jl): Introduces some friction to enforce some quality.
...
- [StrategyLevel3Robust.jl](StrategyLevel3Robust.jl): Resilience over speed.
